        ...
        <>
            <div className='w-full 1000px:flex items-center'>
                ...
                <div className='1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]'>
                    <textarea
                        className='dark:text-white resize-none text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[60px] 1500px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[60%] bg-transparent'
                    ...
                    <textarea
                        ...
                        className='dark:text-white text-black font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w[74%] bg-transparent'
                    ></textarea>
                    <br />
                    <br />
                    <br />
