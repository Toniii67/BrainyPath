...
import { BsLink45Deg, BsLinkedin, BsPencil } from 'react-icons/bs';
...
const CourseContent: FC<Props> = ({
    ...
    const handleRemoveLink = (index: number) => {
        const updatedData = [...courseContentData]
        updatedData[index].links.splice(0, 1);
        setCourseContentData(updatedData)
    }
    ...
    const handleAddLink = (index: number) => {
        ...
        if (!updatedData[index].links) {
            // Jika properti links belum ada, inisialisasi dengan array kosong
    ...
    return (
        <div className='w-[80%] m-auto mt-24 p-3'>
                            ...
                            <div className={`w-full bg-[#cdc8c817] p-4 ${showSectionInput ? "mt-10" : "mb-0"}`}>
                                ...
                                <div className='flex w-full items-center justify-between my-0'>
                                    ...
                                    <div className='flex items-center'>
                                        <AiOutlineDelete
                                            className={`dark:text-white text-[20px] mr2 text-black ${index > 0 ? "cursor-pointer" : "cursor-no-drop"}`}
                                            onClick={() => {
                                                if (index > 0) {
                                                    const updatedData = [...courseContentData]
                                    ...
                                    <>
                                        ...
                                        <div className='mb-3 block'>
                                            <div className='w-full flex items-center justify-between'>
                                                ...
                                                <AiOutlineDelete
                                                    className={`${index === 0 ? "cursor-no-drop" : "cursor-pointer"
                                                        } text-black dark:text-white text-[20px]`}
                                                    onClick={() => {
                                                        index === 0 ? null : handleRemoveLink(index)
                                                    }}
                                                />
                                            </div>
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    const updatedData = [...courseContentData]
                                                    updatedData[index].linkTitle = e.target.value
                                                    setCourseContentData(updatedData)
                                                }}
                                            />
                                            <input
            ...
            <div className='w-full flex items-center justify-between'>
                ...
                <div className='w-full 800px:w-[180px] flex items-center justify-center h-[40px] bg-[#37a39a] text-center text-white rounded mt-8 cursor-pointer' onClick={() => handleOptions()}>
                    Next
                </div>
            </div>
            <br />
