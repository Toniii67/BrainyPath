        ...
        <div className={`mt-[15px] w-full ${!props.isDemo && 'ml-[30px] sticky top-24 left-0 z-30'}`}>
            {
                videoSection.map((section: string, sectionIndex:number) => {
                    ...
                    return(
                        <div className={`${!props.isDemo && 'border-b border-[#ffffff83] pb-2'}`} key={section}>
                                    ...
                                    {sectionVideos.map((item:any, index: number) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                } cursor-pointer transition-all p-2`} key={item._id} onClick={() => props.isDemo ? null : props?.setActiveVideo(videoIndex)}
                                            >
