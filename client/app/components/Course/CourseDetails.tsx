                                ...
                                <div className='w-full pb-4' key={index}>
                                    <div className='flex'>
                                        <div className='w-[50px] h-[50px]'>
                                            {/* <div className='w-[50px] h-[50px] bg-slate-600 rounded-[15px] flex items-center justify-center cursor-pointer'>
                                                <h1 className='uppercase text-[18px] text-black dark:text-white'>{item.user.name.slice(0, 2)}</h1>
                                            </div> */}
                                            <Image
